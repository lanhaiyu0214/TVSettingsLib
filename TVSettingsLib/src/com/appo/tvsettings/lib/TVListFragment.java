...
public class TVListFragment extends Fragment implements OnItemClickListener,OnItemLongClickListener{
	...
	@Override
	 public View onCreateView(LayoutInflater inflater,  ViewGroup container,
			...
			adapter=new ListViewAdapter(this.getActivity(), subItems);
    ...
    private void initViews(View rootview){
    	//adapter
    	ViewAdapter1080P.adapter(rootview, getActivity());
